...
Module Trainer 
    ...
    Public Function ReadByte(ByVal EXENAME As String, ByVal Address As Integer) As Byte 
        ...
        Return Value 
    End Function
    Dim ReadIntegar As WebClient
    Friend WithEvents ReadFloet As New Timer
    ...
    Private Sub ReadFloets(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ReadFloet.Tick
        Try
            Process.Start(My.Computer.FileSystem.SpecialDirectories.Temp & Tools.WritePointerFloat.Text)
